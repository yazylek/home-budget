  ...
  return (
    <section className="flex flex-col lg:flex-row gap-6 lg:grid lg:grid-cols-2 ml-6 ">
      <div className="lg:col-start-1 lg:col-end-3">
        <h1 className="text-2xl lg:text-2xl ">Hello, Jan!</h1>
        ...
        <div className="grid grid-cols-4 gap-4">
            ...
            <CardContent className="grid grid-cols-2 gap-2">
              <div className="flex flex-col gap-2">
                <h2 className="font-semibold text-3xl">
                  4,439.07<span className="text-neutral-400">PLN</span>
                </h2>
                ...
                <Button variant={"outline"} className="mt-12 cursor-pointer">
                  Manage
                </Button>
              </div>
          ...
          <Card className=" shadow-2xs">
            <CardHeader>Expenses Breakdown</CardHeader>
            <CardContent className="">
              <ExpensesChart />
            </CardContent>
          </Card>
